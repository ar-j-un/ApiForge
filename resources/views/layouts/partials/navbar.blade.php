<header class="header header-sticky p-0 mb-4">
    <div class="container-fluid border-bottom px-4">
        ...
        <ul class="header-nav ms-auto">
            ...
            <li class="nav-item">
                <a href="{{ route('login') }}" class="btn btn-link nav-link py-2 px-2 d-flex align-items-center gap-1 text-white text-decoration-none">
                    <svg class="icon icon-lg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        <path fill="var(--ci-primary-color, currentcolor)" d="M472 96H40a24.03 24.03 0 0 0-24 24v80h32v-72h416v256H48v-72H16v80a24.03 24.03 0 0 0 24 24h432a24.03 24.03 0 0 0 24-24V120a24.03 24.03 0 0 0-24-24" class="ci-primary" />
                        <path fill="var(--ci-primary-color, currentcolor)" d="m212.687 323.078 22.626 22.627 90.511-90.509-90.511-90.51-22.626 22.628 51.881 51.882H16v31.999h248.569z" class="ci-primary" />
                    </svg>
                    Login
                </a>
            </li>
